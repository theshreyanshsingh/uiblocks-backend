...
const ExplanationSchema = z.object({
  ...
  tool: z.string().describe("The tool to be used, if any, e.g., ''"),
  command: z
    .string()
  ...
  url: z.string().describe("A relevant URL, if applicable, e.g., ''"),
  code: z
    .string()
    .describe(
...
export const LeaderOutputSchema = z.union([ExplanationSchema, RoutingSchema]);

export type leadOutput = z.infer<typeof LeaderOutputSchema>;
